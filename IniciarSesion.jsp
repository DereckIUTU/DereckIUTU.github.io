        ...
        <div class="login">
            <div class="login-div">
                <div class="login-title">
                    ...
                    <p>Bienvenido al sistema de inicio de sesión.
                    </p>
                </div>
                <div class="login-form">                  
                    <form action="Login?accion=Ingresar" method="POST" onsubmit="return ValidarLogin()">
                        <label>Usuario</label>
                        <input type="text" name="User" class="form-control" id="usuario" style="border-radius: 30px;">
                        <label>Contraseña</label>
                        <input type="password" name="Password" class="form-control" id="contraseña" style="border-radius: 30px;">
                        <input type="submit" name="accion" value="Iniciar sesión" class="login-btn-s" id="btn">
                    </form>
                </div>
                <a class="created-count" href="Registrarse.jsp">Aún no tengo una cuenta (Registrarse).</a>
            </div>
        </div>
